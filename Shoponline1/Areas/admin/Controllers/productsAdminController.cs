...
namespace Shoponline1.Areas.admin.Controllers
{
    public class productsAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,price,img,img1,img2,img3,description,meta,size,color,hdie,order,datebegin,categoryid")] product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,price,img,img1,img2,img3,description,meta,size,color,hdie,order,datebegin,categoryid")] product product)
        {
            if (ModelState.IsValid)
            {
