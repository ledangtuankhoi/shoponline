...
namespace Shoponline1.Areas.admin.Controllers
{
    public class menusAdminController : Controller
    {
        ...
        // GET: admin/menusAdmin
        public ActionResult Index()
        {
            return View(db.menus.ToList());
        }

        // GET: admin/menusAdmin/Details/5
        ...
        // GET: admin/menusAdmin/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: admin/menusAdmin/Create
        ...
        // POST: admin/menusAdmin/Delete/5
