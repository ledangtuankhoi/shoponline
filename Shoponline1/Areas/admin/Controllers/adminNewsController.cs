...
namespace Shoponline1.Areas.admin.Controllers
{
    public class adminNewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,img,description,detail,meta,hide,order,datebegin")] News news)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,img,description,detail,meta,hide,order,datebegin")] News news)
        {
            if (ModelState.IsValid)
            {
